...
> docker run --env NDAYS=$DAYS --env TICKER=$STOCK -i -p $PORT:8080 temitopeajisafe/mystockwebserviceapp:latest
...
$PORT - This is the port number where the web service will be listening to for requests.
